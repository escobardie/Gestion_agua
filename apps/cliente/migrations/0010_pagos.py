# Generated by Django 5.1 on 2024-10-06 19:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cliente', '0009_alter_venta_options_alter_ventaproducto_options_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cliente.cliente', verbose_name='Pagos')),
            ],
            options={
                'verbose_name': 'Pago',
